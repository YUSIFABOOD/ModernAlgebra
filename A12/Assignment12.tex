...
% 46. Show that 2Z < 3Z is not a subring of Z.
We show that the set $2\mathbb{Z} \cup 3\mathbb{Z}$ is not a ring as it is not closed under addition. We know that any element in $2\mathbb{Z}, 3\mathbb{Z}$ is written as $2k, 3s$ respectively, where $k,s \in \mathbb{Z}.$ Observe when $k=s=5$, $2k+3s=25$ and $25 \notin 2\mathbb{Z} \wedge 25 \notin 3\mathbb{Z}$, so it is not in $2\mathbb{Z}\cup 3\mathbb{Z}$. Hence, $2\mathbb{Z}\cup 3\mathbb{Z}$ is not closed under addition. Thus, $2\mathbb{Z}\cup 3\mathbb{Z}$ is not a ring.
\end{document}